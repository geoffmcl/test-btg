...
# Modified by Geoff R. McLane, for this altlas-g project
...
macro(find_sg_library libName varName libs)
    ...
    FIND_LIBRARY(${libVarName}_DEBUG
      NAMES ${libName}d ${libName}${CMAKE_DEBUG_POSTFIX} 
    ...
    FIND_LIBRARY(${libVarName}_RELEASE
      NAMES ${libName} ${libName}${CMAKE_RELEASE_POSTFIX} 
      HINTS $ENV{SIMGEAR_DIR}
      PATH_SUFFIXES ${CMAKE_INSTALL_LIBDIR} lib libs64 libs libs/Win32 libs/Win64
      PATHS
      ${ADDITIONAL_LIBRARY_PATHS}
...
if (NOT SIMGEAR_INCLUDE_DIR)
    message(FATAL_ERROR "*** Cannot find SimGear includes! (Forgot 'make install' for SimGear?) "
            "Compile & INSTALL SimGear before configuring this project. "
            "When using non-standard locations, use 'SIMGEAR_DIR' to set the SimGear location.")
endif()
...
if(NOT SIMGEAR_VERSION)
    message(FATAL_ERROR "*** Unable to find SimGear or simgear/version.h does not exist/is invalid. "
            "Make sure you have installed the SimGear ${SimGear_FIND_VERSION} or greater includes. "
            "When using non-standard locations, please use 'SIMGEAR_DIR' "
            "to select the SimGear library location to be used.")
endif()

message(STATUS "*** Found SimGear version: ${SIMGEAR_VERSION}. Need greater than ${SimGear_FIND_VERSION}!")

if ("${SIMGEAR_VERSION}" VERSION_GREATER "${SimGear_FIND_VERSION}")
    message(STATUS "*** Found version: ${SIMGEAR_VERSION} greater than ${SimGear_FIND_VERSION}.")
else ()
    message(FATAL_ERROR "*** Found version: ${SIMGEAR_VERSION} NOT greater than ${SimGear_FIND_VERSION}. "
            "Please use environment 'SIMGEAR_DIR' to select the SimGear library location to be used.")
endif ()
...
if(SIMGEAR_SHARED)
  ...
  #  message(STATUS "all libs ${SIMGEAR_LIBRARIES}")
    ...
    if(WIN32)
        list(APPEND SIMGEAR_CORE_LIBRARY_DEPENDENCIES ws2_32.lib winmm.lib )
    endif(WIN32)
