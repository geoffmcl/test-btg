...
#define SPRTF2(a) cerr.flush(); printf("\n%5.2f: %s\n",(logTimer.elapsedMSec() / 1000.0),a); cout.flush()
...
int main(int argc, char* argv[])
{
    ...
    SPRTF2("start test_binobj");

    SPRTF2("test_empty");
    test_empty();
    SPRTF2("test_basic");
    test_basic();
    SPRTF2("test_many_tcs");
    test_many_tcs();
    SPRTF2("test_big");
    test_big();
    SPRTF2("test_some_objects");
    test_some_objects();
    SPRTF2("test_many_objects");
    test_many_objects();
    SPRTF2("done");
